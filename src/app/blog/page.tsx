...
export default function BlogListPage() {
    ...
    const fetchBlogs = async () => {
      ...
      try {
        const params = new URLSearchParams({
          limit: '100',
          feed: activeFeed === 'popular' ? 'popular' : 'newest',
        });
  ...
  }, [activeCategory, activeFeed, search, toast]);
