          ...
          <div className="container mx-auto max-w-5xl relative z-10 text-center space-y-8">
            ...
            >
              ...
              <motion.p variants={fadeUp} className="text-sm md:text-xl text-muted-foreground max-w-3xl mx-auto font-sans leading-relaxed font-medium">
                From a small studio in Kanpur to homes across India — this is the story of Kalamic. Handcrafted décor inspired by Indian heritage, refined for contemporary living.
              </motion.p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="space-y-6 text-muted-foreground font-medium leading-relaxed">
                  <p>It was 2019. Our founder was renovating his family home in Kanpur, Uttar Pradesh — a city where heritage meets industrial grit at every corner.</p>
                  <p>During the renovation, workers removed an old carved wooden pillar (Stambh) that had stood for decades. It was discarded. That pillar wasn't just wood; it was a family memory.</p>
                  ...
                  <p>The problem was clear: modern homes were becoming stylish, but cultural identity was disappearing. Mass production was replacing character. Kalamic was founded to fight that.</p>
                </div>
              ...
              <motion.div 
                ...
                className="relative w-full aspect-[4/5] md:aspect-[3/4] lg:aspect-[4/5] rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white bg-muted"
              >
                <Image 
                  src="https://ik.imagekit.io/ari07rsa2/kalamic/products/handmade-ceramic-mandala-wheel-wall-art-with-lord-ganesha--peacock-motifs-img-8-_3J9rg5IPZ.png?updatedAt=1773301631627" 
          ...
          <div className="container mx-auto px-6 max-w-5xl relative">
            ...
            <div className="space-y-12 md:space-y-32">
              {[
                ...
                { year: "2021", title: "First Collection", desc: "Launched our first line of handcrafted Mor Stambh pillars and temple décor in Kanpur." },
        ...
        <section className="py-20 md:py-32 px-6">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-3xl md:text-5xl font-serif font-bold text-foreground">Clay is India's oldest medium.</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
              <div className="grid grid-cols-2 gap-4 md:gap-6">
                ...
                <div className="space-y-4 md:space-y-6 pt-12">
                  <div className="relative w-full aspect-[3/4] rounded-[2rem] overflow-hidden shadow-lg bg-muted">
                    <Image src="https://ik.imagekit.io/ari07rsa2/kalamic/gallery/images/best-ceramic-mirror-1775328694967.webp?updatedAt=1775328696872" alt="Kiln firing prep" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover" data-ai-hint="pottery firing" />
                  </div>
                  <div className="relative w-full aspect-square rounded-[2rem] overflow-hidden shadow-lg bg-muted">
                    <Image src="https://ik.imagekit.io/ari07rsa2/kalamic/products/handmade-ceramic-mandala-wheel-wall-art-with-lord-ganesha--peacock-motifs-img-3-_qF07r-CmT.png?updatedAt=1773301547188" alt="Final piece finishing" fill sizes="(max-width: 768px) 50vw, 25vw" className="object-cover" data-ai-hint="pottery finishing" />
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">Hand-detailing leather-hard clay using loop tools. A Mor Stambh has thousands of individual marks.</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">Layered application of oxide washes and glazes fired at 1100°C for a durable, glossy finish.</p>
                    </div>
                  </div>
                </div>
                    ...
                    <table className="w-full text-left text-xs font-medium">
                      <thead>
                        <tr className="border-b border-border">
                          <th className="py-2 pr-4 text-muted-foreground font-black uppercase tracking-wider">Motif</th>
                          <th className="py-2 pr-4 text-muted-foreground font-black uppercase tracking-wider">Meaning</th>
                          <th className="py-2 text-muted-foreground font-black uppercase tracking-wider">Used In</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-border/50">
                        <tr><td className="py-3 pr-4 text-primary font-bold">Mor (Peacock)</td><td className="py-3 pr-4">Grace, Beauty, Protection</td><td className="py-3">Mor Stambh</td></tr>
                        <tr><td className="py-3 pr-4 text-primary font-bold">Stambh (Pillar)</td><td className="py-3 pr-4">Stability, Sacred Threshold</td><td className="py-3">Pillars</td></tr>
                        <tr><td className="py-3 pr-4 text-primary font-bold">Mandala</td><td className="py-3 pr-4">Wholeness, Geometry</td><td className="py-3">Wall Art</td></tr>
                        <tr><td className="py-3 pr-4 text-primary font-bold">Owl</td><td className="py-3 pr-4">Wisdom, Prosperity</td><td className="py-3">Photo Frames</td></tr>
                      </tbody>
                    </table>
                  </div>
                </div>
            ...
            <div className="bg-primary/5 rounded-[3rem] p-10 md:p-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                ...
                <div className="space-y-6 text-muted-foreground font-medium">
                  <p>Kalamic works with a small, dedicated team of artisans based in Kanpur. Our artisans are not factory workers; they are master craftsmen trained in traditional clay-working techniques.</p>
