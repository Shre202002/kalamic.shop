...
export const metadata: Metadata = { title: 'Indian Home Decor Guides | Kalamic', description: 'Practical guides to ceramic decor, wall mirrors, gifting, heritage motifs and caring for handmade pieces.' };
