      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 md:gap-12">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-display font-bold tracking-tight text-primary">Kalamic</h2>
            <p className="text-[#b0a090] text-sm leading-relaxed max-w-xs font-medium">
            ...
            <div className="flex gap-6">
              <Link href="/" className="text-[#b0a090] hover:text-primary transition-colors" title="Website">
              ...
              <Link 
                ...
                className="text-[#b0a090] hover:text-primary transition-colors"
                title="Instagram"
              >
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-white mb-8">Shop</h3>
          ...
          {/* Support */}
          <div>
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-white mb-8">Support</h3>
            <ul className="space-y-4 text-sm text-[#b0a090] font-medium">
        ...
        <div className="border-t border-white/10 mt-24 pt-12 text-center">
